...
/// the necessary conversions. FeeRate is represented internally as sat/kvb.
...
/// Models the result of "getblock "blockhash" [verbosity=2]"
#[derive(Clone, PartialEq, Debug, Deserialize, Serialize)]
